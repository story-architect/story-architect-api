...
def handle_relationship_created(db: Session, story_id: uuid.UUID, relationship_id: uuid.UUID, char_a_name: str, char_b_name: str):
    create_event(
        db,
        story_id=story_id,
        relationship_id=relationship_id,
...
def handle_report_generated(db: Session, story_id: uuid.UUID, title: str, description: str, character_id: Optional[uuid.UUID] = None, relationship_id: Optional[uuid.UUID] = None):
    create_event(
        db,
        story_id=story_id,
        character_id=character_id,
...
def handle_question_answered(db: Session, story_id: uuid.UUID, question_text: str, answer_text: str, character_id: Optional[uuid.UUID] = None, relationship_id: Optional[uuid.UUID] = None):
    ...
    if character_id:
        ...
        if insight_fields["central_conflict"] != "Not discovered yet." and "need" not in insight_fields["central_conflict"].lower():
