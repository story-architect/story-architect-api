...
CHARACTER_QUESTIONS = [
    ...
    },
    {
        ...
        "order_index": 3,
        "suggested_answers": ["'I don't need anyone'", "'If I'm perfect, I won't be rejected'", "'Emotions are a weakness'"]
    },
    {
        "flow_type": FlowTypeEnum.CHARACTER_DISCOVERY,
...
RELATIONSHIP_QUESTIONS = [
    ...
    },
    {
        ...
        "order_index": 4,
        "suggested_answers": ["The villain's plot", "A painful truth", "Their own destructive habits", "Society's judgment"]
    },
    {
        "flow_type": FlowTypeEnum.RELATIONSHIP_DISCOVERY,
        ...
        "order_index": 5,
        "suggested_answers": ["Thinking the other doesn't care", "Believing they are enemies", "Assuming they are a burden"]
    },
    {
        "flow_type": FlowTypeEnum.RELATIONSHIP_DISCOVERY,
    ...
    },
    {
        ...
        "order_index": 7,
        "suggested_answers": ["The real reason they stayed", "The identity of the traitor", "The extent of their sacrifice"]
    }
]
